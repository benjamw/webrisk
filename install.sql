...
--
-- Host: localhost
-- Generation Time: Jan 15, 2015 at 10:25 PM
...
CREATE TABLE IF NOT EXISTS `player` (
	...
	`timezone` varchar(255) COLLATE latin1_general_ci NOT NULL DEFAULT 'UTC',
...
CREATE TABLE IF NOT EXISTS `wr_game_log` (
	...
	`data` varchar(255) COLLATE latin1_general_ci DEFAULT NULL,
	`create_date` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
...
CREATE TABLE IF NOT EXISTS `wr_game_player` (
	...
	`cards` varchar(255) COLLATE latin1_general_ci DEFAULT NULL,
	`armies` smallint(5) unsigned NOT NULL DEFAULT '0',
	`state` enum('Waiting','Trading','Placing','Attacking','Occupying','Fortifying','Resigned','Dead') COLLATE latin1_general_ci NOT NULL DEFAULT 'Waiting',
...
CREATE TABLE IF NOT EXISTS `wr_wr_player` (
	...
	`color` varchar(25) COLLATE latin1_general_ci NOT NULL DEFAULT 'yellow_black',

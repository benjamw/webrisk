...
--
-- Host: localhost
-- Generation Time: Jun 23, 2009 at 03:16 AM
...
CREATE TABLE IF NOT EXISTS `wr_game` (
  ...
  `multiple_fortify` tinyint(1) NOT NULL DEFAULT '0',
  `connected_fortify` tinyint(1) NOT NULL DEFAULT '0',
  `place_initial_armies` tinyint(1) NOT NULL DEFAULT '0',
  `game_type` enum('Original','Secret Mission','Capital') NOT NULL DEFAULT 'Original',
  `next_trade` tinyint(3) unsigned NOT NULL DEFAULT '4',
...
CREATE TABLE IF NOT EXISTS `wr_game_player` (
  ...
  `occupy_info` varchar(15) DEFAULT NULL,

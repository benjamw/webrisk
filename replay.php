...
$meta['title'] = htmlentities($Replay->name, ENT_QUOTES, 'UTF-8', false).' - #'.$_SESSION['game_file'];
...
?>
		...
		<div id="contents">
			...
			<h2>Game #<?php echo $Replay->id.': '.htmlentities($Replay->name, ENT_QUOTES, 'UTF-8', false); ?> <span class="type"><a href="#game_info" class="fancybox">Game Info</a></span></h2>
			...
			<div id="board">
				...
				<?php
					$board = $Replay->get_visible_board( );
				...
				<div id="next"><?php echo $Replay->get_trade_value( ); ?></div>
				<?php echo $Replay->draw_players( ); ?>
			...
			<div id="game_info">
				...
				<?php
					$player_data = $Replay->get_players_visible_data( );
					unset($player_data[0]);
				...
				<table class="game_info">
					<tbody>
						<tr>
							<th>Game Type</th>
							<td><?php echo $Replay->get_type( ); ?></td>
						</tr><tr>
							<th>Placement Type</th>
							<td><?php echo $Replay->get_placement( ); ?></td>
						</tr><tr>
							<th>Placement Limit</th>
							<td><?php echo $Replay->get_placement_limit( ); ?></td>
						</tr><tr>
							<th>Fortification Type</th>
							<td><?php echo $Replay->get_fortify( ); ?></td>
						</tr><tr>
							<th>Kamikaze</th>
							<td><?php echo $Replay->get_kamikaze( ); ?></td>
						</tr><tr>
							<th>Warmonger</th>
							<td><?php echo $Replay->get_warmonger( ); ?></td>
						</tr><tr>
							<th>Fog of War</th>
							<td><?php $fog_of_war = $Replay->get_fog_of_war( );
								echo 'Armies: '.$fog_of_war['armies'].'<br />Colors: '.$fog_of_war['colors']; ?></td>
						</tr><tr>
							<th>Trade Count</th>
							<td><?php echo $Replay->get_trade_count( ); ?></td>
						</tr><tr>
							<th>Custom Trade Array</th>
							<td><?php
								$trades = $Replay->get_trade_array( );
							...
							<td><?php echo $Replay->get_trade_card_bonus( ); ?></td>
						</tr><tr>
							<th>Conquer Limit</th>
							<td><?php echo $Replay->get_conquer_limit( ); ?></td>
						</tr><tr>
							<th>Custom Rules</th>
							<td><?php echo htmlentities($Replay->get_custom_rules( ), ENT_QUOTES, 'UTF-8', false); ?></td>
						</tr>
					</tbody>
				</table> <!-- .game_info -->

				<?php
					$extra_info = $Replay->get_extra_info( );
